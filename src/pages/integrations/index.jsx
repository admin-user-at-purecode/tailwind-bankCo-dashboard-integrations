...
function Integrations() {
  return (
    <main className="w-full xl:px-[48px] px-6 pb-6 xl:pb-[48px] sm:pt-[156px] pt-[100px]">
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-10 2xl:grid-rows-4 gap-3 lg:gap-4 xl:gap-6">
        <div className="2xl:col-span-5 card1">
          <Integration integration={integrations[0]} />
        </div>
        <div className="2xl:col-span-5 card2">
          <Integration integration={integrations[1]} />
        </div>
        <div className="2xl:col-span-6 2xl:col-start-3 2xl:row-start-2  card3">
          <Integration integration={integrations[2]} />
        </div>
        <div className="2xl:col-span-5  2xl:row-start-3   card4">
          <Integration integration={integrations[3]} />
        </div>
        <div className="2xl:col-span-5 2xl:row-start-3    card5">
          <Integration integration={integrations[4]} />
        </div>
        <div className="2xl:col-span-2 card6">
          <Integration integration={integrations[5]} />
        </div>
        <div className="2xl:col-span-2 card7">
          <Integration integration={integrations[6]} />
        </div>
        <div className="2xl:col-span-3 card8">
          <Integration integration={integrations[7]} />
        </div>
        <div className="2xl:col-span-4 card9">
          <Integration integration={integrations[8]} />
        </div>
        <div className="2xl:col-span-3 card10">
          <Integration integration={integrations[9]} />
        </div>
        <div className="2xl:col-span-7 card11">
          <Integration integration={integrations[10]} />
        </div>
        <div className="2xl:col-span-3 card12">
